...
🎮 Plataforma 2D com física realista (Phaser.js)
🎮 2D platform with realistic physics (Phaser.js)

📚 Questões educativas por categoria
📚 Educational questions by category

🤖 IA adaptativa baseada em desempenho
🤖 Adaptive AI based on performance

🏆 Sistema completo de gamificação e ranking
🏆 Full gamification and leaderboard system
...
⚡ Robust RESTful API with Express.js
...
4️⃣ Inicialize o banco / Initialize DB

npm run init-db


5️⃣ Inicie o servidor / Start backend
